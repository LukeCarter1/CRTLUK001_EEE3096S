...
int main(void)
{
  ...
  while (1)
  {
	...
	// ADC to LCD; TODO: Read POT1 value and write to LCD xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
	uint32_t adcValue = pollADC();
	snprintf(POT1_str, sizeof(POT1_str), "%lu", adcValue);
	writeLCD(POT1_str);

	// Update PWM value; TODO: Get CRR xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
...
void EXTI0_1_IRQHandler(void)
{
	// TODO: Add code to switch LED7 delay frequency   xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
...
uint32_t ADCtoCCR(uint32_t adc_val){
  // TODO: Calculate CCR val using an appropriate equation xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
